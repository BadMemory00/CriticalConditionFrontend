<template>
    <svg width="1027.5" height="696.05" data-name="Layer 1" version="1.1" viewBox="0 0 1027.5 696.05" xmlns="http://www.w3.org/2000/svg">
 ...
 <path d="m670.59 174.51-17.09 8.0883 15.125-11.31a85.352 85.352 0 0 0-8.2584-10.867l-74.117 18.422 66.948-25.538a85.339 85.339 0 0 0-9.7218-7.4102l-112.94 18.191a84.639 84.639 0 0 0-18.537 52.82h170a84.594 84.594 0 0 0-11.413-42.396z" fill="#f2f2f2"/>
 <path d="m684.12 50.195a495.97 495.97 0 0 0-218.12-50.195c-153.83 0-291.36 69.753-382.71 179.35 156.43-34.274 428.78-93.606 600.83-129.15z" fill="#f2f2f2"/>
 ...
 <g transform="translate(0 -.00050561)" fill="#00a89c">
 ...
 <g transform="translate(0 -.00050561)" fill="#f2f2f2">
 ...
 <g transform="translate(0 -.00050561)" fill="#00a89c">
  <path d="m474.36 372.62-0.97627-0.0191c0.021-1.0811 0.63114-26.561 10.662-33.604l0.56059 0.79893c-9.6263 6.7586-10.242 32.564-10.247 32.824z"/>
  <circle cx="489.21" cy="333.8" r="4.8813"/>
  <path d="m488.22 351.03a15.198 15.198 0 0 1-7.8415 0.33859 13.85 13.85 0 0 1 14.24-4.8844 15.198 15.198 0 0 1-6.3984 4.5458z"/>
  <path d="m614.36 372.62-0.97627-0.0191c0.021-1.0811 0.63114-26.561 10.662-33.604l0.56059 0.79893c-9.6263 6.7586-10.242 32.564-10.247 32.824z"/>
  <circle cx="629.21" cy="333.8" r="4.8813"/>
  <path d="m628.22 351.03a15.198 15.198 0 0 1-7.8415 0.33859 13.85 13.85 0 0 1 14.24-4.8844 15.198 15.198 0 0 1-6.3984 4.5458z"/>
 ...
 <g transform="translate(0 -.00050561)" fill="#2f2e41">
 ...
 <path d="m90.867 508.93c-6.3789-28.568 14.012-57.434 45.544-64.475s62.265 10.41 68.644 38.978-14.519 39.104-46.051 46.145-61.758 7.9201-68.137-20.647z" fill="#00a89c"/>
 <g transform="translate(0 -.00050561)" fill="#2f2e41">
  ...
  <ellipse transform="rotate(-.16049)" cx="907.55" cy="691.1" rx="20" ry="7.5"/>
  <ellipse transform="rotate(-.16049)" cx="859.55" cy="690.1" rx="20" ry="7.5"/>
 </g>
 <circle cx="891.13" cy="563.11" r="27" fill="#fff"/>
 <circle cx="891.13" cy="563.11" r="9" fill="#3f3d56"/>
 <path d="m969.62 509.42c6.2989-28.585-14.173-57.394-45.724-64.347-31.552-6.9525-62.236 10.584-68.535 39.17s14.628 39.063 46.18 46.015c31.552 6.9525 61.78 7.7471 68.079-20.838z" fill="#00a89c"/>
 <ellipse transform="rotate(-25.535)" cx="650.7" cy="916.18" rx="39.5" ry="12.4" fill="#2f2e41"/>
 <path d="m932.07 611.5c0.022 7.732-19.844 23.056-41.935 23.118-22.091 0.0619-42.865-21.648-42.887-29.38-0.0216-7.732 20.717 1.442 42.809 1.3801s41.992-2.8496 42.014 4.8824z" fill="#fff"/>
 ...
 <path d="m128.08 262.65c-1.188-29.247 24.019-54.019 56.301-55.331s59.415 21.335 60.603 50.582-21.252 35.892-53.534 37.203-62.181-3.2078-63.369-32.455z" fill="#00a89c"/>
 ...
 <path d="m168.71 379.72a18 18 0 0 0 35.424 6.4128c1.7708-9.7821-5.7924-13.244-15.575-15.014s-18.079-1.1805-19.85 8.6017z" fill="#fff"/>
 <rect transform="rotate(16.689)" x="368.24" y="164.34" width="74" height="66" fill="#3f3d56"/>
 <g transform="translate(0 -.00050561)" fill="#00a89c">
  <path d="m312.87 333.98-0.92967-0.29863c0.33056-1.0296 8.2322-25.261 19.863-29.127l0.30755 0.92627c-11.162 3.7095-19.162 28.252-19.241 28.499z"/>
  <circle cx="338.24" cy="301.05" r="4.8813"/>
  <path d="m332.34 317.28a15.198 15.198 0 0 1-7.6084-1.9275 13.85 13.85 0 0 1 15.043-0.58938 15.198 15.198 0 0 1-7.4343 2.5169z"/>
 </g>
</svg>
